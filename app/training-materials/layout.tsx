...
export default async function TrainingMaterialsLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!dbUser?.isAdmin && !roleAccess["training"]) redirect("/knowledge");
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <AppHeader session={effectiveSession} isAdmin={effectiveIsAdmin} notifications={notifications} unread={unread} activePage="training-materials" roleAccess={effectiveRoleAccess} newHires={newHires} previewingAs={previewingAs} />
